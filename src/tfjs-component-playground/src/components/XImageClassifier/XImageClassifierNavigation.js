...
export class XImageClassifierNavigation extends LitElement {
    ...
    return html`
      ...
      <div id="controls">
        <mwc-button
          id="image-urls"
          icon="http"
          @click=${() => navigateByPath(this._path + 'mobilenet/single/aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2toZXJyaWNrL3RmanMtY29tcG9uZW50LXBsYXlncm91bmQvbWFzdGVyL2Fzc2V0cy9kZW1vLzc=')}
        >
          Image Urls
        </mwc-button>
        <mwc-button
          id="github-avatars"
          icon="face"
          @click=${() => navigateByPath(this._path + 'mobilenet/range/0x9999999/domain/github-avatars/3065761')}
        >
          Github Avatars
        </mwc-button>
        <mwc-button
...
defineCustomElement('x-image-classifier-navigation', XImageClassifierNavigation)
